...
async function generateTestPdf() {
        ...
        data.heatmap.zones.forEach((zone) => {
            if (zone.severity === "CRITICAL" || zone.severity === "MODERATE") {
                ...
                doc
                    .fillColor(color)
                    .fontSize(12)
                    .text(`- [${zone.severity}] ${zone.name} : ${zone.cases} cas signalés.`, { continued: true });
    ...
    doc
        .fillColor("grey")
        .fontSize(9)
        .text("Ce document est confidentiel et destiné uniquement aux autorités sanitaires.", { align: "center" });

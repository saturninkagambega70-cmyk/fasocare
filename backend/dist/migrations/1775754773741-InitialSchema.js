...
exports.InitialSchema1775754773741 = void 0;
class InitialSchema1775754773741 {
    constructor() {
        this.name = "InitialSchema1775754773741";
    }
    async up(queryRunner) {
        ...
        `);
        await queryRunner.query(`CREATE INDEX "IDX_consultations_patient" ON "consultations" ("patient_id")`);
        await queryRunner.query(`CREATE INDEX "IDX_consultations_doctor" ON "consultations" ("doctor_id")`);
        await queryRunner.query(`CREATE INDEX "IDX_consultations_created_at" ON "consultations" ("created_at")`);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`CREATE INDEX "IDX_vaccinations_patient" ON "vaccinations" ("patient_id")`);
        await queryRunner.query(`CREATE INDEX "IDX_vaccinations_next_dose" ON "vaccinations" ("next_dose_date")`);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`CREATE INDEX "IDX_epidemic_reports_doctor" ON "epidemic_reports" ("doctor_id")`);
        await queryRunner.query(`CREATE INDEX "IDX_epidemic_reports_status" ON "epidemic_reports" ("status")`);
        await queryRunner.query(`
...
exports.InitialSchema1775754773741 = InitialSchema1775754773741;
//# sourceMappingURL=1775754773741-InitialSchema.js.map